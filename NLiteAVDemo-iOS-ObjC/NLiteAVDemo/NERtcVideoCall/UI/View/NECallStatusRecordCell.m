...
- (NSMutableDictionary *)getShowData:(NECallStatusRecordModel *)model {
    ...
    switch (model.status) {
        case NIMRtcCallStatusComplete:{
            ...
            NSString *time = [NSString stringWithFormat:@"%@ %@",[self getCallTime:model.startTime], [self getCallDurationString:model.duration]];
...
- (void)getUnCompleteStatus:(NSMutableDictionary *)dataDic withModel:(NECallStatusRecordModel *)model {
